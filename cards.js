...
// Create a <p> element and append it to a <div> element:
    ...
    var collectedInput = userInput.value;					
    // console.log("collectedInput", collectedInput);			// userInput.value = outputs the actual text the user submitted
...
console.log("userInput", userInput);
	...
	var text = document.createTextNode(collectedInput);		    // Create a text node element (reference to the user's input)
